  ...
  <header class="h-16 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-100 dark:border-zinc-800 sticky top-0 z-30 transition-colors duration-300">
    <div class="max-w-5xl mx-auto px-8 h-full flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        <!-- Dark Mode Toggle -->
        <button @click="toggleDark" class="p-2 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors focus:outline-none" title="Toggle Theme">
        ...
        <button class="p-2 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors relative">
        ...
        <button class="p-2 text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
